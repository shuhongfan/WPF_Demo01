...
namespace Client.AirportServiceReference {
    ...
    public interface IAirportService {
        ...
        void SubmitAirportMessage(Client.AirportServiceReference.AirportMessage message);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="WcfMsmqExamples/IAirportService/SubmitAirportMessage")]
        System.Threading.Tasks.Task SubmitAirportMessageAsync(Client.AirportServiceReference.AirportMessage message);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAirportServiceChannel : Client.AirportServiceReference.IAirportService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AirportServiceClient : System.ServiceModel.ClientBase<Client.AirportServiceReference.IAirportService>, Client.AirportServiceReference.IAirportService {
        ...
        public void SubmitAirportMessage(Client.AirportServiceReference.AirportMessage message) {
            base.Channel.SubmitAirportMessage(message);
        }
        
        public System.Threading.Tasks.Task SubmitAirportMessageAsync(Client.AirportServiceReference.AirportMessage message) {
